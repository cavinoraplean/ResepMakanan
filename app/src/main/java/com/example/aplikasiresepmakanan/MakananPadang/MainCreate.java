...
public class MainCreate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_padang);
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("")){
                    ...
                    Toast.makeText(MainCreate.this, "Silahkan Masukkan Gambar",
                            Toast.LENGTH_SHORT).show();
                } else {
                    Enama.setText("");
                    Eresep.setText("");
                    ...
                    Toast.makeText(MainCreate.this, "Data telah ditambah",
                            Toast.LENGTH_SHORT).show();
                    db.CreateMasakanPadang(new MasakanPadang(null, Snama, Sresep, Sgambar));
                    Intent a = new Intent(MainCreate.this, MainMakananPadang.class);
                    startActivity(a);
                }
            }
        });
