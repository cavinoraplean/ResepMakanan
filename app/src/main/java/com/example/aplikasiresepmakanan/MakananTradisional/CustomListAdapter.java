...
public class CustomListAdapter extends BaseAdapter {
    ...
    private List<MakananTradisional> movieItems;
    public CustomListAdapter(Activity activity, List<MakananTradisional> movieItems) {
...
//        ImageView imageView = (ImageView) convertView.findViewById(R.id.iconid);
        MakananTradisional m = movieItems.get(position);
